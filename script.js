window.addEventListener("DOMContentLoaded", async () => {
    ...
    let repeat =  () => {
        if (i < text.length) {
            ...
            document.querySelector('#bdcake').style.animation = 'fadein 0.8s forwards ease'
            
            document.querySelector('#content').style.animation = 'fadein 1s forwards ease'
            
        
        }
    }
 new TypingFireworks("#text");
 repeat() 
});
